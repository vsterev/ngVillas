...
## Runing the project
the main folder contains two folder villas-API and ng-app
...
ng serve
```
Angular application will be run on port 4200
...
The Project Аnti Covid Travel 2020 is based on  Jave Script, for the  back-end there have been used  Mongoose, Express JS, ANgularJS, MAterial design, JWT, cookies
